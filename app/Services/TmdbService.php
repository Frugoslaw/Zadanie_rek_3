...
class TmdbService
{
    ...
    public function __construct()
    {
        ...
        $this->languages = LanguageEnum::all(); // Pobieranie języków z Enuma
    }
    ...
    public function fetchMovies(): void
    {
        $response = Http::withToken($this->readToken)
            ->get('https://api.themoviedb.org/3/movie/popular', [
                'api_key'  => $this->apiKey,
                'language' => LanguageEnum::ENGLISH->value, // Użycie Enuma
                'page'     => 1,
            ]);
    ...
    public function fetchGenres(): void
    {
        ...
        foreach ($allGenres as $genreData) {
            // Tworzymy dynamicznie tablicę tłumaczeń na podstawie enuma
            $translations = [];
